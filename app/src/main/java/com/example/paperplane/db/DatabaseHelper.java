...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String Zhihu=("create table if not exists Zhihu("
    ...
    public static final String Guokr=("create table if not exists Guokr("
            + "id integer primary key autoincrement,"
    ...
    public static final String  Douban=("create table if not exists Douban("
            + "id integer primary key autoincrement,"
